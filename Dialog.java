...
public class Dialog {
  ...
  public static void createCharacter(Player player) {
    ...
    player.Name = JOptionPane.showInputDialog("Enter your name");
    ...
    classSelect = (String) JOptionPane.showInputDialog(null, "Choose Your Class...", "", JOptionPane.QUESTION_MESSAGE, null, classes, classes[0]);
  ...
  public static void Encounter(Player player, Enemy enemy) {
    JOptionPane.showMessageDialog(null, "Got jumped by a: " + enemy.Type);
    String enemyOverview = "Your Enemy:\n" + "Type:" + enemy.Type + "\n" + "Health :" + enemy.maxHealth + "\n" + "Weapon Name: " + enemy.weaponName + "\n" + "Attack Power :" + enemy.Atk;
